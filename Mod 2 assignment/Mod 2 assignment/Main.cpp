...
#include "../../../../../../OpenGL/OpenGL/GLEW/include/GL/glew.h"
#include "../../../../../../OpenGL/OpenGL/GLFW/include/GLFW/glfw3.h"
...
namespace
{
    const char* const WINDOW_TITLE = "Mod 2 Assignment"; // window title
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLint stride = sizeof(float) * (static_cast<unsigned long long>(floatsPerVertex) + floatsPerColor);// The number of floats before each
...
bool UCreateShaderProgram(const char* vtxShaderSource, const char* fragShaderSource, GLuint& programId)
{
    ...
    if (!success)
    {
        ...
        std::cout << "ERROR: SHADER VERTE FAILED\n" << infoLog << std::endl;
